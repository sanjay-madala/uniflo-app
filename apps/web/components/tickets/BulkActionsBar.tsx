...
import { UserPlus, XCircle, Tag, Download, X } from "lucide-react";
...
export function BulkActionsBar({ selectedCount, onAssign, onClose, onTag, onExport, onClear }: BulkActionsBarProps) {
